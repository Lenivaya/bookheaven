...
vi.mock('@/app/user/dashboard/reviews/searchParams', () => ({
...
describe('ReviewsSearch', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(useDebouncedCallback).mockImplementation((callback: any) => {
  ...
  it('does not apply autofocus when isAutoFocusable is false', () => {
    render(<ReviewsSearch isAutoFocusable={false} />)

    // Check if the input does not have the autofocus property
    const searchInput = screen.getByPlaceholderText('Search reviews...')
